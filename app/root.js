...
function($rootScope, $scope, $mdSidenav, $mdToast, $mdDialog, $cookies, services, focus) {
	...
	self.uid_password  = '_session_password';
        ...
        //special key only for my computer
        self.uid_special_key  = '_session_special';
	...
	root.isCookieExist = function(){
		...
		var password = $cookies.get(root.base_url+self.uid_password);
              ...
              //Ahmed - Added a special key for protection
                var special_key = $cookies.get(root.base_url+self.uid_special_key);
		//if(uid == null || name == null || email == null || password == null || special_key !== 'acrtyueiqioehftayhgaf;joubmdetrkgoyhfh'){
